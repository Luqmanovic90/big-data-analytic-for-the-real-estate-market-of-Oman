	  ...
	  _createClass(BootstrapTable, [{
	    ...
	    value: function initTable() {
	      ...
	      if (!this.$header.length) {
	        this.$header = $("<thead id=\"table-row-border\" class=\"".concat(this.options.theadClasses, "\"></thead>")).appendTo(this.$el);
		...
		if (this.options.cardView) {
          	if(Utils.getFieldTitle(_this7.columns, this.header.fields.length - 1) == "") {
				html.push("<td style=\"border-bottom: solid 1px #00000008 !important; border-top: none;\" colspan=\"".concat(this.header.fields.length, "\">"));
				html.push("<div class=\"row\"><div class=\"card-views col-11\">");  
				isActionButton = true;
			} else if(Utils.getFieldTitle(_this7.columns, 0) == "") {
				if(!item._class) {
					html.push("<td style=\"border-bottom: solid 1px #00000008 !important; border-top: none;\" colspan=\"".concat(this.header.fields.length, "\">"));
					html.push("<div class=\"row\">");
					html.push("<div class=\"col-1 pl-1 align-items-center d-flex\"></div>");
				}
				else if(item._class.indexOf("main-row") >= 0) {
					html.push("<td style=\"border-bottom: solid 1px #00000008 !important; border-top: none;\" colspan=\"".concat(this.header.fields.length, "\">"));
					html.push("<div class=\"row\">");
					html.push("<div class=\"col-1 px-0 card-view-value pl-1 align-items-center d-flex\" data-toggle=\"collapse\" data-target=\".group-of-rows-" + row_index + "\"><i class=\"la la-angle-down\"></i></div>");
					row_index ++;
				} else {
					html.push("<td class=\"subrow-dark hiddenRow\" style=\"border-bottom: solid 1px #00000008 !important; border-top: none;\" colspan=\"".concat(this.header.fields.length, "\">"));
					html.push("<div class=\"row\">");
					html.push("<div class=\"col-1 pl-1 align-items-center d-flex\"></div>");
				}
				html.push("<div class=\"card-views col-11\">");  
			} else {
				html.push("<td style=\"border-bottom: solid 1px #00000008 !important; border-top: none;\" colspan=\"".concat(this.header.fields.length, "\">"));
				html.push("<div class=\"card-views\">");
			}
		}
        ...
        var actionValue;
	      this.header.fields.forEach(function (field, j) {
            ...
            var cardTitle;
            if(Utils.getFieldTitle(_this7.columns, field) == "") {
              actionValue = "<span class=\"card-view-value font-weight-bold ".concat(cellStyle.classes, "\"").concat(style_, ">").concat(value, "</span>");
              cardTitle = _this7.options.showHeader ? "<span class=\"card-view-title ".concat(cellStyle.classes, "\"").concat(style_, ">").concat(Utils.getFieldTitle(_this7.columns, field), "</span>") : '';
              return false;
            }
            else {
				if(!item._class) {
					cardTitle = _this7.options.showHeader ? "<span class=\"card-view-title subrow ".concat(cellStyle.classes, "\"").concat(style_, ">").concat(Utils.getFieldTitle(_this7.columns, field), ":&nbsp;</span>") : '';
				} else if(item._class.indexOf("main-row")) {
					var mainrow_index = row_index - 1;
					cardTitle = _this7.options.showHeader ? "<span style=\"line-height: 40px;\" class=\"card-view-title collapse group-of-rows-" + mainrow_index + " subrow ".concat(cellStyle.classes, "\"").concat(style_, ">").concat(Utils.getFieldTitle(_this7.columns, field), ":&nbsp;</span>") : '';
					view_style = "line-height: 40px;";
				}
				else
					cardTitle = _this7.options.showHeader ? "<span class=\"card-view-title subrow ".concat(cellStyle.classes, "\"").concat(style_, ">").concat(Utils.getFieldTitle(_this7.columns, field), ":&nbsp;</span>") : '';
			}
	          text = "<div style=\"display: flex;\" class=\"card-view\">".concat(cardTitle, "<span style=\"" + view_style + "\" class=\"card-view-value font-weight-bold ").concat(cellStyle.classes, "\"").concat(style_, ">").concat(value, "</span></div>");
          ...
          html.push('</div>');
          if(isActionButton) {
            html.push("<div style=\"margin-left: -10px; display:flex; align-items:center;\" class=\"col-1\">");
            html.push(actionValue);
            html.push("</div>");
            html.push("</div>");
          }
          html.push('</td>');
